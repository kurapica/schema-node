export default {
    ...
    "system.schema.enumschema.color": "使用颜色",
    ...
    "system.schema.funcschema": "函数类型定义",
    "system.schema.funcschema.return": "返回值类型",
    "system.schema.funcschema.args": "函数参数列表",
    "system.schema.funcschema.exps": "函数表达式列表",
    "system.schema.funcschema.generic": "泛型参数",
    "system.schema.funcschema.server": "仅服务器调用",
    "system.schema.funcschema.nocache": "前端不缓存结果",
    ...
    "system.schema.app": "应用定义命名空间",
    "system.schema.app.srcapp": "应用",
    "system.schema.app.srcfld": "应用字段",
    "system.schema.app.accessfld": "访问字段",
    "system.schema.app.appinput": "应用名(输入用)",
    "system.schema.app.pushfld": "推送用字段",
    "system.schema.app.pushflds": "推送字段列表",
    "system.schema.app.fieldvalarg": "参数",
    "system.schema.app.fieldvalarg.name": "应用字段名",
    "system.schema.app.fieldvalarg.value": "常量",
    "system.schema.app.fieldvalargs": "参数列表",
    "system.schema.app.fieldrelation": "应用字段数据关联",
    "system.schema.app.fieldrelation.field": "应用字段",
    "system.schema.app.fieldrelation.type": "关联类型",
    "system.schema.app.fieldrelation.func": "关联函数",
    "system.schema.app.fieldrelation.args": "关联参数",
    "system.schema.app.fieldrelations": "应用字段数据关联列表",
    "system.schema.app.field": "应用字段",
    "system.schema.app.field.name": "字段名",
    "system.schema.app.field.type": "字段类型",
    "system.schema.app.field.display": "字段展示",
    "system.schema.app.field.desc": "字段描述",
    "system.schema.app.field.sourceapp": "引用应用",
    "system.schema.app.field.sourcefld": "引用字段",
    "system.schema.app.field.func": "计算函数",
    "system.schema.app.field.args": "函数参数",
    "system.schema.app.field.incrupdate": "增量数据",
    "system.schema.app.field.frontend": "仅前端用",
    "system.schema.app.field.disable": "禁用",
    "system.schema.app.field.combine": "数据合并规则",
    "system.schema.app.field.trackpush": "跟踪推送",
    "system.schema.app.field.readonly": "只读",
    "system.schema.app.app": "应用定义",
    "system.schema.app.app.name": "应用名",
    "system.schema.app.app.display": "应用展示",
    "system.schema.app.app.desc": "应用描述",
    "system.schema.app.app.relations": "应用字段数据关联列表",

    "system.schema.app.apptarget": "应用及目标",
    "system.schema.app.apptarget.app": "应用",
    "system.schema.app.apptarget.target": "目标",
    "system.schema.app.getapptargets": "获取目标列表",
